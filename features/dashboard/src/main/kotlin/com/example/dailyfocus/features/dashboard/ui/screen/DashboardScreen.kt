    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                StatCard(
                    stat = StatUiState(title = "Completadas", value = stats.tasksCompleted),
                    modifier = Modifier.weight(1f)
                )
                StatCard(
                    stat = StatUiState(title = "Pendientes", value = stats.tasksPending),
                    modifier = Modifier.weight(1f)
                )
            }
        }
        ...
        item {
            StatCard(stat = StatUiState(title = "Total tareas ", value = stats.totalTasks))
        }
    }
}
