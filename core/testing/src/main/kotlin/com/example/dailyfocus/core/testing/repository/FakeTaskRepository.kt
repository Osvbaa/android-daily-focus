...
class FakeTaskRepository(var latencyMillis: Long = 0) : TaskRepository {
    ...
    override suspend fun createTaskFromNote(title: String, noteId: String): TaskMutationResult = mutation {
        require(title.isNotBlank())
        val task = Task(id = nextTaskId(), title = title.trim(), linkedNoteId = noteId, createdAtMillis = 0L)
